            ...
            try:
                if branch != "False":
                    get_branch = requests.get(
                        "https://api.github.com/repos/MasoniteFramework/cookie-cutter/branches/{0}".format(
                            branch
                        )
                    )
                    ...
                    zipball = "https://github.com/MasoniteFramework/cookie-cutter/archive/{0}.zip".format(
                        branch
                    )
                elif version != "False":
                    ...
                    get_zip_url = requests.get(
                        "https://api.github.com/repos/MasoniteFramework/cookie-cutter/releases/tags/v{0}".format(
                            tags[0]
                        )
                    )
